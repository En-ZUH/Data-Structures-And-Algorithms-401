...
const Binary_Tree = require('../../../Tree/Binary Tree/tree').Binary_Tree;
const Node = require('../../../Tree/Binary Tree/tree').Node;
...
describe('Testing of Hashmap tree Intersection', () => {
    ...
    beforeAll(() => {
        ...
        xx.left = yy;
        xx.right = zz;
        tree_4 = new Binary_Tree(xx);

        tree_5 = new Binary_Tree();
    });
    ...
    it('Successfully return an exception for the empty treee', () => {
