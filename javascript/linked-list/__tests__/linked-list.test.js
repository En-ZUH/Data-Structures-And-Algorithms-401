...
//         expect(list.toString()).toEqual('{ last } -> { first } -> { 30 } -> { 20 } -> { 10 } -> { name } -> { Enas } -> { 20 } -> { 10 } -> { 25 } -> { 4 } -> { 3 } -> { 2 } -> { 1 } -> { 4 } -> { 3 } -> { 2 } -> { 1 } -> { 100 } -> { 10 } -> { 1 } -> { 7 } -> { 5 } -> { 10 } -> { 0 } -> { 10 } -> { 20 } -> { 30 } -> {40} -> NULL');
...
//         expect(list.toString()).toEqual('{ last } -> { first } -> { 30 } -> { 20 } -> { 10 } -> { name } -> { Enas } -> { zuhair } -> { 20 } -> { 10 } -> { 25 } -> { 4 } -> { 3 } -> { 2 } -> { 1 } -> { 4 } -> { 3 } -> { 2 } -> { 1 } -> { 100 } -> { 10 } -> { 1 } -> { 7 } -> { 5 } -> { 10 } -> { 0 } -> { 10 } -> { 20 } -> { 30 } -> {40} -> NULL');
...
//         expect(list.toString()).toEqual('{ last } -> { first } -> { 30 } -> { 20 } -> { 10 } -> { name } -> { Enas } -> { zuhair } -> { 20 } -> { 10 } -> { 25 } -> { 4 } -> { 3 } -> { 2 } -> { 1 } -> { 4 } -> { 3 } -> { 2 } -> { 1 } -> { 100 } -> { 10 } -> { 1 } -> { 7 } -> { 5 } -> { 10 } -> { 0 } -> { 10 } -> { 20 } -> { 30 } -> { 40 } -> {final} -> NULL');
//     });
...
//         let ll = new LinkedList().append(5).append(10);
//         expect(ll.kthFromEnd('Enas')).toEqual('Exception');
//     });
